...
export type ProductWhereInput = {
  ...
  readonly priceRent?: Scalars['Int'] | null;
  readonly priceRent_not?: Scalars['Int'] | null;
  readonly priceRent_lt?: Scalars['Int'] | null;
  readonly priceRent_lte?: Scalars['Int'] | null;
  readonly priceRent_gt?: Scalars['Int'] | null;
  readonly priceRent_gte?: Scalars['Int'] | null;
  readonly priceRent_in?: ReadonlyArray<Scalars['Int'] | null> | null;
  readonly priceRent_not_in?: ReadonlyArray<Scalars['Int'] | null> | null;
};
...
export type ProductListTypeInfo = {
  key: 'Product';
  fields: 'id' | 'name' | 'description' | 'status' | 'priceBuy' | 'priceRent';
  backing: {
    readonly id: string;
    readonly name?: string | null;
    ...
    readonly priceRent?: number | null;
  };
  inputs: {
